...
/**
 * Google Code Jam YYYY RoundRR Problem P: 
...
public class ProblemSolution {
	...
	public static void init(int inRunMode){
		...
		if(username.equalsIgnoreCase("baloghend")){
			INPUT_DIRECTORY = "../../GoogleCodeJam/RoundQ2014"; //at work
		} else if(username.equalsIgnoreCase("user")){
			INPUT_DIRECTORY = "../../GoogleCodeJam/RoundQ2014"; //at home/desktop
		} else {
			INPUT_DIRECTORY = "../../../GoogleCodeJam/RoundQ2014";   //at home/laptop
		}
