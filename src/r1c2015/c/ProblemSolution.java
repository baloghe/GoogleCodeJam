...
public class ProblemSolution {
	...
	public static void init(int inRunMode){
		...
		if(username.equalsIgnoreCase("baloghend")){
			INPUT_DIRECTORY = "../../GoogleCodeJam/Round1C2015"; //at work
		} else if(username.equalsIgnoreCase("user")){
			INPUT_DIRECTORY = "../../GoogleCodeJam/Round1C2015"; //at home/desktop
		} else {
			INPUT_DIRECTORY = "../../../GoogleCodeJam/Round1C2015";   //at home/laptop
		}
